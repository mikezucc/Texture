...
A layout describes how nodes should be dimensioned for display. This information defines how the sizes of nodes and also their horizontal or vertical ordering.
